...
<html >
	...
	<h3 align="center">[<a href="teacher/pageup.jsp?showPage=<%=p.getShowPage()-1 %>">上一页</a>|第<%=p.getShowPage()%>页|<a href="teacher/pagedown.jsp?showPage=<%=p.getShowPage()+1  %>">下一页</a>|共<%=p.getPageNum() %>页|<a href="teacher/lastpage.jsp?showPage=<%=p.getPageNum()  %>">末页</a>]</h3>
