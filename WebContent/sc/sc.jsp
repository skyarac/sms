...
<html >
	...
	<h3 align="center">[<a href="sc/pageup.jsp?showPage=<%=p.getShowPage()-1 %>">上一页</a>|第<%=p.getShowPage()%>页|<a href="sc/pagedown.jsp?showPage=<%=p.getShowPage()+1 %>">下一页</a>|共<%=p.getPageNum() %>页|<a href="sc/lastpage.jsp?showPage=<%=p.getPageNum()%>">末页</a>]</h3>
