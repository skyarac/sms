...
<html >
	...
	<body>
		...
		<table align="center" style="width:980px" >
			...
			<%
			p.setShowPage(Integer.parseInt(request.getParameter("showPage")));
	...
	<h3 align="center">[<a href="user/users.jsp?showPage=<%=p.getShowPage()-1 %>">上一页</a>|第<%=p.getShowPage()%>页|<a href="user/users.jsp?showPage=<%=p.getShowPage()+1%>">下一页</a>|共<%=p.getPageNum() %>页|<a href="user/users.jsp?showPage=<%=p.getPageNum()  %>">末页</a>]</h3>
