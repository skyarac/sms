...
<h3 align="center">[<a href="student/pageup.jsp?showPage=<%=p.getShowPage()-1 %>">上一页</a>|第<%=p.getShowPage()%>页|<a href="student/pagedown.jsp?showPage=<%=p.getShowPage()+1 %>">下一页</a>|共<%=p.getPageNum() %>页|<a href="student/lastpage.jsp?showPage=<%=p.getPageNum()%>">末页</a>]</h3>
